...
Сервер слушает `localhost:8089`, команды CLI обращаются к нему (`--addr` в виде `host:port` или URL). API — [Connect](https://connectrpc.com/) (gRPC и JSON поверх HTTP), описан в [api/v1/service.proto](api/v1/service.proto).
